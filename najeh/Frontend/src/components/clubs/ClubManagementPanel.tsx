...
const ClubManagementPanel: React.FC<ClubManagementPanelProps> = ({
  ...
  const handleDeleteMember = async (memberId: number) => {
    if (!club || !club.creatorId) {
      toast({
        title: "Erreur",
        description: "Informations du club manquantes. Veuillez rafraîchir la page.",
        variant: "destructive"
      });
      return;
    }
    ...
    try {
      ...
      let errorMessage = "Impossible de supprimer le membre du club.";
      ...
      if (err.name === "ServerError") {
        ...
        errorMessage = "Membre ou club non trouvé.";
